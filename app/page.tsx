            ...
            <div className="lg:flex lg:items-center lg:justify-between">
              <div className="flex-1 min-w-0 text-center lg:text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 items-center sm:items-start">
                  <button
                    onClick={() => handleNavigation("projects")}
                    className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 w-100 sm:w-auto"
                  >
                    Download CV
                  </button>
                  <button
                    onClick={() => handleNavigation("contact")}
                    className="mt-3 sm:mt-0 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-blue-600 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 w-100 sm:w-auto"
                  >
                    Contact Me
                  </button>
                </div>
